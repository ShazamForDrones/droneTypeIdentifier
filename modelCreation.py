...
norm_params_name = f'normalization_params_{timestamp}.npy'
np.save(norm_params_name, {'train_min': train_min, 'train_max': train_max})
print(f"✅ Paramètres de normalisation sauvegardés sous : {norm_params_name}")
print(f"   train_min={train_min:.4f}, train_max={train_max:.4f}")
